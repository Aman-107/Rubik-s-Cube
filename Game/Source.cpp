...
void display()
{
	...
	if (rotation == 2)
	{
		...
		else
		{
			glPushMatrix();
			glColor3fv(color[0]);
			output(-11, 6, (char*)"RightInverted");
			glPopMatrix();
			glRotatef(theta, 1.0, 0.0, 0.0);
		}
		colorcube4();
	...
	if (rotation == 3)
	{
		...
		else
		{
			glPushMatrix();
			glColor3fv(color[0]);
			output(-11, 6, (char*)"FrontInverted");
			glPopMatrix();
			glRotatef(theta, 0.0, 0.0, 1.0);
		}
		colorcube6();
	...
	if (rotation == 6)
	{
		...
		else
		{
			glPushMatrix();
			glColor3fv(color[0]);
			output(-11, 6, (char*)"BottomInverted");
			glPopMatrix();
			glRotatef(-theta, 0.0, 1.0, 0.0);
		}
		colorcube2();
